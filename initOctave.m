...
imCor(6).name = 'qMT (SIR-FSE) #1';
imCor(7).im = rescan.fsir.data;
imCor(7).name = 'qMT (SIR-FSE) #2';
imCor(8).im = scan.spgr.data;
imCor(8).name = 'qMT (SPGR) #1';
imCor(9).im = rescan.spgr.data;
imCor(9).name = 'qMT (SPGR) #2';
